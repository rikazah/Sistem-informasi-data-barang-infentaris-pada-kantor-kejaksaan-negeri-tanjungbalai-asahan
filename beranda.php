    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong><marquee bgcolor="blue", behavior="alternate", scrollamount="12">Selamat Datang di Sistem Informasi Data Barang Infentaris pada Kantor Kejaksaan Negeri Asahan</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Barang Infentaris pada Kejaksaan Negeri Tanjung Balai-Asahan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nama Pegawai</th><th>Nip</th><th>Jabatan</th><th>Bidang</th><th>Nama Barang</th>
                            </tr>
                        </thead>
                        <tbody>
